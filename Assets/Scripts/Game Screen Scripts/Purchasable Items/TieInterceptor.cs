...
public class TieInterceptor : MonoBehaviour
{
    ...
    public static float tieinterceptorValue = 1000000;
    ...
    void Update()
    {
        ...
        txtPlaceholder.GetComponent<Text>().text = ""+ tieinterceptorValue;
        txtActual.GetComponent<Text>().text = ""+tieinterceptorValue;
        counter.GetComponent<Text>().text = "" + elementCounter;
        Acounter.GetComponent<Text>().text = "" + elementCounter;

        if (currentCredits >= tieinterceptorValue) {
